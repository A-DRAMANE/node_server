...
export const getIdItemController = async (req: Request, res: Response) => {
...
export const putItemController = async (req: Request, res: Response) => {
    const id: number = parseInt(req.params.id, 10);
...
export const delItemController = async (req: Request, res: Response) => {
    try {
      const id: number = parseInt(req.params.id, 10);
